// ============================================================================
// uix-platform/src/windows/file_dialog.rs — Windows file dialog (IFileDialog)
// ============================================================================
...
use crate::windows::util::{to_utf8, to_wide};
use crate::IFileDialog;
use std::ptr;
...
impl Default for WindowsFileDialog {
    fn default() -> Self {
        Self::new()
    }
}
