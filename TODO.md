...
按照[文档中心](docs/README.md#文档边界与事实来源)的治理规则，带时点的任务、进度、负责人、阻塞和公开 API 测试结果不在仓库内复制，唯一事实源是 [Gitea 0.0.1 产品完成父 Issue #1](http://100.79.245.29:3000/admin/uix-app/issues/1) 及其子 Issue。
