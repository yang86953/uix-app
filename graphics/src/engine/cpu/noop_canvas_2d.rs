...
impl Canvas2D for NoopCanvas2D {
    ...
    fn draw_box_shadow_ambient(&mut self, _: Rect, _: f32, _: f32, _: f32, _: Color, _: Option<Radius>) {}
    ...
    fn surface_size(&self) -> Size { Size::new(0.0, 0.0) }
    fn current_clip(&self) -> Rect { Rect::new(0.0, 0.0, 1.0, 1.0) }
}
