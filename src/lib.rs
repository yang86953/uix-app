...
#[path = "../tests/unit/uix_lang_codegen_consumer_tests.rs"]
mod uix_lang_codegen_consumer_tests;
// 隔离图表共同高级配置的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_chart_codegen_consumer_tests.rs"]
mod uix_lang_chart_codegen_consumer_tests;
// 隔离 Calendar 日期所有权与 Change 映射的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_calendar_consumer_tests.rs"]
mod uix_lang_calendar_consumer_tests;
// 隔离 Container 复合视觉简写的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_container_consumer_tests.rs"]
mod uix_lang_container_consumer_tests;
// 隔离动态文本状态分流的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_dynamic_text_consumer_tests.rs"]
mod uix_lang_dynamic_text_consumer_tests;
// 隔离 Anchor 活动指示线配置的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_anchor_configuration_consumer_tests.rs"]
mod uix_lang_anchor_configuration_consumer_tests;
// 隔离 Breadcrumb 分隔符与折叠阈值的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_breadcrumb_configuration_consumer_tests.rs"]
mod uix_lang_breadcrumb_configuration_consumer_tests;
// 隔离 Form 顶层全模型规则的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_form_rules_consumer_tests.rs"]
mod uix_lang_form_rules_consumer_tests;
// 隔离 FocusTrap active 开关的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_focus_trap_consumer_tests.rs"]
mod uix_lang_focus_trap_consumer_tests;
// 隔离 Image 命名状态 View 的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_image_slots_consumer_tests.rs"]
mod uix_lang_image_slots_consumer_tests;
// 隔离 List 边框与尺寸配置的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_list_configuration_consumer_tests.rs"]
mod uix_lang_list_configuration_consumer_tests;
// 隔离 Menu 内联始终展开模式的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_menu_inline_consumer_tests.rs"]
mod uix_lang_menu_inline_consumer_tests;
// 隔离 Pagination 显示策略、跳转入口与尺寸选项的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_pagination_configuration_consumer_tests.rs"]
mod uix_lang_pagination_configuration_consumer_tests;
// 隔离 Steps 点击策略与圆点样式的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_steps_configuration_consumer_tests.rs"]
mod uix_lang_steps_configuration_consumer_tests;
// 隔离 Tabs 方位与溢出滚动配置的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_tabs_configuration_consumer_tests.rs"]
mod uix_lang_tabs_configuration_consumer_tests;
// 隔离 Popover 完整配置与受控状态的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_popover_consumer_tests.rs"]
mod uix_lang_popover_consumer_tests;
// 隔离 Tooltip 方向与触发方式的公开 API 编译测试。
#[cfg(test)]
// 将测试实现统一存放在根 tests 目录。
#[path = "../tests/unit/uix_lang_tooltip_consumer_tests.rs"]
mod uix_lang_tooltip_consumer_tests;
