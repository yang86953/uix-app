...
impl TextBackend for AbGlyphBackend {
    ...
    fn layout_text(&self, font: &FontHandle, text: &str, opts: &TextLayoutOptions) -> TextLayout {
        ...
        let v_off = if max_h > text_h {
            match opts.v_align {
                crate::graphics::VAlign::Top | crate::graphics::VAlign::Baseline => 0.0,
                crate::graphics::VAlign::Middle => (max_h - text_h) * 0.5,
                crate::graphics::VAlign::Bottom => max_h - text_h,
            }
        } else { 0.0 };
