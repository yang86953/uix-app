...
impl StyleManager {
    ...
    pub fn set_rounded(&mut self, radius: f32) { self.style.border_radius = radius; }
    pub fn rounded(&self) -> f32 { self.style.border_radius }
    ...
    pub fn set_elevation(&mut self, elevation: f32) { self.style.elevation = elevation; }
    pub fn elevation(&self) -> f32 { self.style.elevation }

    pub fn set_padding(&mut self, p: EdgeInsets) { self.style.padding = p; }
    pub fn padding(&self) -> EdgeInsets { self.style.padding }
}
