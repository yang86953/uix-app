...
pub struct TextManager {
    ...
    bold: bool,
    italic: bool,
    alignment: crate::graphics::HAlign,
}
...
impl TextManager {
    ...
    pub fn color(&self) -> Option<crate::graphics::Color> {
        self.color
    }
    pub fn set_color(&mut self, c: crate::graphics::Color) {
        self.color = Some(c);
    }
    ...
    pub fn alignment(&self) -> &crate::graphics::HAlign {
        &self.alignment
    }
    pub fn set_alignment(&mut self, a: crate::graphics::HAlign) {
        self.alignment = a;
    }
