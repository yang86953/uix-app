...
pub struct Locale {
    ...
    pub pagination_prev_symbol: &'static str,
    pub pagination_next_symbol: &'static str,
    ...
    pub table_sort_asc: &'static str,
    pub table_sort_desc: &'static str,
    pub table_sort_unsorted: &'static str,
    // ── Timeline ──
...
macro_rules! zh { () => { Locale {
    ...
    cascader_arrow: "›", cascader_placeholder: "请选择",
