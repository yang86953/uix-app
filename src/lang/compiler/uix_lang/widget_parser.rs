...
fn parse_value_type(source: &str) -> Option<WidgetValueType> {
    if let Some(declaration) = crate::lang::compiler::components::value_declaration(source) {
        return declaration.allowed_in_props.then(|| WidgetValueType::Library(source.into()));
    }
...
fn parse_state_prop_type(source: &str) -> Option<WidgetValueType> {
    if let Some(declaration) = crate::lang::compiler::components::value_declaration(source) {
        return declaration.allowed_in_state_props.then(|| WidgetValueType::Library(source.into()));
    }
...
pub(crate) fn registered_value_type(name: &str) -> Option<WidgetValueType> {
    if crate::lang::compiler::components::value_declaration(name).is_some() { return Some(WidgetValueType::Library(name.into())); }
...
pub(crate) fn parse_typed_value(source: &str) -> Option<WidgetValueType> {
    if crate::lang::compiler::components::value_declaration(source).is_some() { return Some(WidgetValueType::Library(source.into())); }
