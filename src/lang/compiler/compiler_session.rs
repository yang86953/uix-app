...
use crate::lang::compiler::uix_import::{
...
pub struct CompilerSession {
    ...
    #[cfg(test)]
    stats: tests::CompilerSessionStats,
}
...
impl CompilerSession {
    ...
    fn compile_file_with_snapshot(
        ...
        if !super::components::has_scope() { return super::components::with_project(path, || self.compile_file_with_snapshot(path, overlays, target))?; }
    ...
    fn check_file_with_snapshot(
        ...
        if !super::components::has_scope() { return super::components::with_project(path, || self.check_file_with_snapshot(path, overlays, requested_target))?; }
...
#[cfg(test)]
#[path = "../tests-src/compiler_session_tests.rs"]
mod tests;
