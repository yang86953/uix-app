...
use crate::lang::compiler::lossless_cst::{CstTokenKind, LosslessCst};
use crate::lang::compiler::source_graph::SourceId;
use crate::lang::compiler::uix_lang::{Declaration, Diagnostic, Document, Node, SourceSpan, parse_document};
...
pub(crate) fn format_source(
    ...
    let parse = if crate::lang::compiler::modules::recognizes_source(source) {
        crate::lang::compiler::modules::parse_source
    } else {
        parse_document
    };
...
#[cfg(test)]
#[path = "../tests-src/formatter_tests.rs"]
mod tests;
