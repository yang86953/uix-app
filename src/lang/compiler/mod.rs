...
mod uix_import;
#[cfg(test)]
#[path = "../tests-src/uix_import_tests.rs"]
mod uix_import_tests;
#[allow(dead_code)]
pub(crate) mod uix_lang;
...
pub struct CompilationKey {
    pub component_catalog_hash: u64,
...
impl CompilationKey {
    pub(crate) fn new(source_graph: &source_graph::SourceGraph, target: CompileTarget) -> Self {
        let root_content_hash = source_graph
            ...
            .unwrap_or_default();
        Self {
            component_catalog_hash: components::identity(),
            root_content_hash,
...
pub struct CompileOutput {
    /// Library units referenced by the emitted code, including data and factories.
    pub required_units: std::collections::BTreeSet<String>,
...
impl CompilerSystem {
    ...
    pub fn query(self, kind: QueryKind) -> QueryOutput {
        ...
        entries.extend(components::query_entries(kind));
...
pub(crate) fn compile_lowered(
    ...
    Ok(CompileOutput {
        required_units: artifact.required_units,
...
pub(crate) struct CompiledArtifact {
    required_units: std::collections::BTreeSet<String>,
    tokens: TokenStream,
...
pub(crate) fn compile_cached_artifact(
    ...
    Ok(CompiledArtifact {
        required_units: plan.required_units.clone(),
...
pub(crate) fn materialize_compile_output(
    ...
    CompileOutput {
        required_units: artifact.required_units.clone(),
