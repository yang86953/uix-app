...
pub enum Body {
    ...
    Native(for<'a, 'env> fn(&mut crate::lang::runtime::Frame<'a, 'env>) -> RuntimeResult<Value>),
}
...
pub enum TaskBody {
    ...
    Native(for<'a, 'env> fn(&mut crate::lang::runtime::Frame<'a, 'env>) -> RuntimeResult<TaskStep>),
}
...
/// Library-defined portable component identity.
