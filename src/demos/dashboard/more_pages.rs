...
use uix::ui::{
    Breadcrumb, BreadcrumbItem, Button, ButtonSize, Collapse, CollapsePanel,
    Container, Divider, Dropdown, Grid, IntoWidgetNode,
    Label, MenuMode, ResultType, Segmented,
    Space, SpaceSize, StepStatus, TabPosition, Tabs,
};
...
pub fn page_custom(tk: &DesignTokens) -> WidgetNode {
    ...
    out.push(uix::tree! { Container::new().size(iw(), 120.0).dir(FlexDirection::Column)
    ...
    out.push(uix::tree! { Container::new().size(iw(), 90.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(iw(), 40.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(iw(), 160.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Timeline::new()
    ...
    out.push(uix::tree! { Container::new().size(iw(), 100.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(iw(), 120.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Tree::new(vec![
    ...
    out.push(uix::tree! { Container::new().size(iw(), 130.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Form::new().gap(4.0).into_node(),
    ]}.into_node());
    out.push(sub(tk, "Calendar — 日历").into_node());
    out.push(uix::tree! { Container::new().size(iw(), 240.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
