...
use uix::ui::{
    AlignItems, Breadcrumb, BreadcrumbItem, Button, ButtonSize, Collapse, CollapsePanel,
    Container, Divider, Dropdown, FlexDirection, Grid, IntoWidgetNode, Label,
    Segmented, Space, SpaceSize, TabPosition, Tabs,
};
use super::{iw, sub, row, wrap_page};
...
pub fn page_nav(tk: &DesignTokens) -> WidgetNode {
    ...
    out.push(uix::tree! { Container::new().size(iw(), 200.0).bg(tk.color_bg_elevated)
