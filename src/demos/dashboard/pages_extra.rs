...
pub fn page_layout(tk: &DesignTokens) -> WidgetNode {
    ...
    out.push(uix::tree! { Grid::two_columns().gap(8.0).pad(uix::base::EdgeInsets::uniform(4.0)).size(INNER_W, 70.0) => [
    ...
    out.push(uix::tree! { Grid::three_columns().gap(8.0).pad(uix::base::EdgeInsets::uniform(4.0)).size(INNER_W, 70.0) => [
...
pub fn page_custom(tk: &DesignTokens) -> WidgetNode {
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 120.0).dir(FlexDirection::Column)
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 90.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 40.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Pagination::new(85, 10).into_node(),
    ]}.into_node());
    out.push(sub(tk, "Result — 结果页缩略").into_node());
    out.push(uix::tree! { Container::new().size(INNER_W, 160.0).dir(FlexDirection::Row).gap(16.0)
        .pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 160.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Timeline::new()
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 100.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 120.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Tree::new(vec![
    ...
    out.push(uix::tree! { Container::new().size(INNER_W, 130.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
        uix::ui::Form::new().gap(4.0).into_node(),
    ]}.into_node());
    out.push(sub(tk, "Calendar — 日历").into_node());
    out.push(uix::tree! { Container::new().size(INNER_W, 240.0).dir(FlexDirection::Column).pad(uix::base::EdgeInsets::uniform(4.0)) => [
