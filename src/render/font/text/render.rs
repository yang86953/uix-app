...
use crate::render::spatial::{PhysicalUnit, SpatialContext, Vec3, AABB3D};
use crate::render::text_backend::TextLayoutOptions;
use crate::render::traits::Canvas2D;
use crate::api::render::{Color, FontHandle, HAlign, VAlign};
...
impl<'a> TextRenderService<'a> {
    ...
    fn blit_glyph_layout(
        ...
        layout: &crate::render::text_backend::TextLayout,
        pos: Point,
        color: Color,
        font_size: f32,
    ) {
...
mod tests {
    ...
    fn draw_text_empty_returns_early() {
        let fs = FontService::new();
        let mut trs = TextRenderService::new(FontHandle::default(), &fs, 500.0);
        let mut canvas = crate::render::engine::cpu::noop_canvas_2d::NoopCanvas2D;
    ...
    fn draw_text_spatial_empty_returns_early() {
        let fs = FontService::new();
        let mut trs = TextRenderService::new(FontHandle::default(), &fs, 500.0);
        let mut canvas_s = crate::render::engine::cpu::noop_canvas_2d::NoopCanvas2D;
        let spatial = crate::render::spatial::SpatialContext::new(
            &mut canvas_s,
            96.0,
            1.0,
    ...
    fn blit_to_with_empty_layout_no_panic() {
        use crate::render::text_backend::TextLayout;
        let fs = FontService::new();
        let mut trs = TextRenderService::new(FontHandle::default(), &fs, 500.0);
        let mut canvas = crate::render::engine::cpu::noop_canvas_2d::NoopCanvas2D;
