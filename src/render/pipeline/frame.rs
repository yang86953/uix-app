...
use crate::render::backend::traits::{BackendCapabilities, DrawSurface};
...
mod tests {
    use super::*;
    use crate::render::backend::cpu::CpuDrawSurface;
    use crate::render::backend::traits::BackendCapabilities;
