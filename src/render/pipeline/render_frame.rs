...
use crate::render::compositor::{LayerTree, RenderObjectTree, ScenePaint};
use crate::render::debug::DebugRenderService;
use crate::render::font_service::FontService;
use crate::render::painting::ThemeSnapshot;
use crate::render::pipeline::{InvalidationSource, RenderMetrics};
use crate::render::font::text::TextRenderService;
use crate::render::traits::{GraphicsEngine, UpdateStrategy};
use crate::render::types::DirtyRegion;
use crate::api::render::{Color, FontHandle, RenderOutcome};
...
mod tests {
    use super::*;
    use crate::render::null_engine::NullEngine;
    ...
    impl ScenePaint for EmptyScene {
        fn root_id(&self) -> Option<crate::render::pipeline::NodeId> {
            None
        }
        ...
        fn node_visible(&self, _: crate::render::pipeline::NodeId) -> bool {
            false
        }
        fn node_frame(&self, _: crate::render::pipeline::NodeId) -> Rect {
            Rect::zero()
        }
        fn node_dirty(&self, _: crate::render::pipeline::NodeId) -> bool {
            false
        }
        fn node_z_index(&self, _: crate::render::pipeline::NodeId) -> i32 {
            0
        }
        fn node_children(&self, _: crate::render::pipeline::NodeId) -> &[crate::render::pipeline::NodeId] {
            &[]
        }
        fn is_repaint_boundary(&self, _: crate::render::pipeline::NodeId) -> bool {
            false
        }
        fn children_clip(&self, _: crate::render::pipeline::NodeId, _: Rect) -> Option<Rect> {
            None
        }
        fn dirty_rect(&self, _: crate::render::pipeline::NodeId, frame: Rect) -> Rect {
            frame
        }
        fn scroll_offset(&self, _: crate::render::pipeline::NodeId) -> Option<(f32, f32)> {
            None
        }
        fn focused_node(&self) -> Option<crate::render::pipeline::NodeId> {
            None
        }
        fn node_focusable(&self, _: crate::render::pipeline::NodeId) -> bool {
            false
        }
        fn hit_test(&self, _: Point) -> Option<crate::render::pipeline::NodeId> {
            None
        }
        fn parent(&self, _: crate::render::pipeline::NodeId) -> Option<crate::render::pipeline::NodeId> {
            None
        }
        fn paint(&self, _: crate::render::pipeline::NodeId, _: Rect, _: &mut PaintContext<'_>) {}
    }

    struct MockTokens;

    impl crate::render::painting::IColorTokens for MockTokens {
    ...
    impl crate::render::painting::ITypographyTokens for MockTokens {
        fn font_family(&self) -> &str {
            "sans"
        }
    }

    impl crate::render::painting::IBoxShadowTokens for MockTokens {
        fn box_shadow(&self) -> crate::render::painting::ShadowToken {
            crate::render::painting::ShadowToken::none()
        }
        fn box_shadow_secondary(&self) -> crate::render::painting::ShadowToken {
            crate::render::painting::ShadowToken::none()
        }
    }

    impl crate::render::painting::ISpacingTokens for MockTokens {}

    impl crate::render::painting::ThemeTokens for MockTokens {}
    ...
    fn first_frame_expands_partial_dirty_to_full_paint_region() {
        ...
        impl ScenePaint for PartialDirtyScene {
            ...
            fn node_frame(&self, id: crate::render::pipeline::NodeId) -> Rect {
                match id {
            ...
            fn node_children(&self, id: crate::render::pipeline::NodeId) -> &[crate::render::pipeline::NodeId] {
                static ROOT_KIDS: [crate::render::pipeline::NodeId; 1] = [2];
                static EMPTY: [crate::render::pipeline::NodeId; 0] = [];
                if id == 1 {
                    &ROOT_KIDS
                } else {
                    &EMPTY
            ...
            fn parent(&self, id: crate::render::pipeline::NodeId) -> Option<crate::render::pipeline::NodeId> {
                if id == 2 {
                    Some(1)
                } else {
                    None
