...
use crate::platform::{Error, Point, Rect};

use crate::render::backend::traits::{
    BackendCapabilities, BackendKind, DamageRegion, DrawSurface, RenderBackend,
};
use crate::render::color::Color;
use crate::render::engine::cpu::canvas_2d::CpuCanvas2D;
use crate::render::engine::cpu::pixel_surface::PixelSurface;
use crate::render::rasterizer::image::blit_image;
use crate::render::traits::Canvas2D;
use crate::render::types::ImageHandle;
...
impl DrawSurface for CpuDrawSurface {
    fn size(&self) -> crate::platform::Size {
...
impl CpuBackend {
    ...
    pub fn blit_offscreen_to_canvas(
        ...
        src_rect: Rect,
        dst_rect: Rect,
        canvas: &mut dyn crate::render::traits::Canvas2D,
    ) {
        let idx = handle.0 as usize;
        if idx >= self.offscreens.len() {
            return;
