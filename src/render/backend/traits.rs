...
use crate::platform::{Error, Point, Rect, Size};

use crate::api::render::primitives::ImageHandle;
use crate::render::traits::{Canvas2D, PresentationMode};
...
impl DamageRegion {
    ...
    /// 转为 platform 呈现损伤。
    pub fn to_present_damage(&self) -> crate::platform::PresentDamage {
        if self.full || self.rects.is_empty() {
            crate::platform::PresentDamage::Full
        } else {
            ...
            if tuples.is_empty() {
                ...
                crate::platform::PresentDamage::Partial(tuples)
            }
        }
    }
}
...
impl From<BackendCapabilities> for crate::render::traits::GraphicsCapabilities {
