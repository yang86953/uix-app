...
impl DrawSurface for GpuDrawSurface {
    fn size(&self) -> crate::platform::Size {
        crate::platform::Size::new(self.width as f32, self.height as f32)
    }
