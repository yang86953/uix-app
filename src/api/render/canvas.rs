...
use super::primitives::{BlendMode, Color, FillRule, GradientDirection, Path, Radius, StrokeOptions};
...
pub trait Canvas2D {
    ...
    fn fill_rect(&mut self, rect: Rect, color: Color, radius: Option<Radius>) {
        ...
        crate::render::rasterizer::fill::fill_rect(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_circle(&mut self, cx: f32, cy: f32, r: f32, color: Color) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::fill::fill_circle(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_ellipse(&mut self, rect: Rect, color: Color) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::fill::fill_ellipse(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_sector(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::fill::fill_sector(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_path(&mut self, path: &Path, color: Color, fill_rule: FillRule) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::fill::fill_path(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn stroke_rect(&mut self, rect: Rect, color: Color, line_width: f32, radius: Option<Radius>) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::stroke::stroke_rect(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn stroke_circle(&mut self, cx: f32, cy: f32, r: f32, color: Color, line_width: f32) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::stroke::stroke_circle(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn stroke_path(&mut self, path: &Path, color: Color, opts: &StrokeOptions) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::stroke::stroke_path(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn draw_line(&mut self, x1: f32, y1: f32, x2: f32, y2: f32, color: Color, width: f32) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::stroke::draw_line(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_linear_gradient(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::gradient::fill_linear_gradient(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn fill_radial_gradient(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::gradient::fill_radial_gradient(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn draw_box_shadow(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::shadow::draw_box_shadow(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn draw_box_shadow_ambient(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::shadow::draw_box_shadow_ambient(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn blit_image(&mut self, src: &[u32], src_w: i32, src_rect: Rect, dst_rect: Rect) {
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::image::blit_image(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
    ...
    fn blit_glyph(
        ...
        let (size, clip, opacity) = (self.surface_size(), self.current_clip(), self.opacity());
        let pixels = self.pixels_mut();
        crate::render::rasterizer::glyph::blit_glyph(
            pixels,
            size.w as i32,
            size.h as i32,
            clip,
