// ============================================================================
// native/backends/windows/util.rs — UTF-8 / UTF-16 conversion helpers
// ============================================================================
...
pub fn windows_diag(code: crate::native::Errc, context: &str) -> Error {
...
pub fn system_default_font_paths() -> Vec<String> {
    unsafe {
        ...
        if let Some(ref name) = sys_font_name {
            crate::core::log::info_fn(format!("System default UI font: {}", name));
        }
