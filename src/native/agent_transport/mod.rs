...
mod unix;
#[cfg(all(test, unix))]
use unix::connect_for_test as platform_connect_for_test;
#[cfg(unix)]
...
use windows::connect_for_test as platform_connect_for_test;
#[cfg(windows)]
...
use unsupported::connect_for_test as platform_connect_for_test;
#[cfg(not(any(unix, windows)))]
