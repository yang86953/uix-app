            ...
            Self::SlideIn {
                ...
                Some(
                    Animation::new(offset, Point::new(0.0, 0.0), *duration)
                        .with_easing(crate::widget::animation::easing::Easing::antd_out()),
                )
            }
            Self::SlideOut {
                direction,
                ...
                Some(
                    Animation::new(Point::new(0.0, 0.0), offset, *duration)
                        .with_easing(crate::widget::animation::easing::Easing::antd_in()),
                )
            }
            _ => None,
        }
        ...
        match self {
            Self::ZoomIn { duration } => Some(
                Animation::new(0.8, 1.0, *duration)
                    .with_easing(crate::widget::animation::easing::Easing::antd_default()),
            ),
