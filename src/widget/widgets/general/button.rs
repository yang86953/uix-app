use crate::widget::animation::core::Animation;
use crate::api::widget::Easing;
use crate::define_widget;
use crate::widget::scene::RenderContext;
use crate::widget::style::Style;
use crate::widget::{EventResult, WidgetEvent, WidgetTree};
use crate::render::{Color, traits::GraphicsEngine};
use crate::platform::{KeyCode, Point, Rect, Size};
...
pub use crate::platform::ControlSize as ButtonSize;
...
define_widget! {
    ...
    render => (&self, frame: Rect, ctx: &mut RenderContext, _tree: &WidgetTree) {
        ...
        crate::widget::scene::apply_style(ctx, btn_frame, &style);
        ...
        if !self.icon.is_empty() {
            let icon_str = crate::widget::widgets::icon::icon_char(&self.icon);
            let saved = *ctx.font();
            if let Some(fh) = crate::widget::widgets::icon::lucide_handle() { ctx.set_font(fh); }
...
impl Button {
    fn compute_style(&self, ctx: &RenderContext) -> Style {
        ...
        s.padding = crate::platform::EdgeInsets::new(
    ...
    /// 设置外边距。
    pub fn margin(mut self, m: crate::platform::EdgeInsets) -> Self {
        self.style.margin = m;
        self
    }

    /// 设置内边距。
    pub fn padding(mut self, p: crate::platform::EdgeInsets) -> Self {
