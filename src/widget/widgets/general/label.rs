...
use crate::render::spatial::PhysicalUnit;
use crate::render::{traits::GraphicsEngine, TextLayoutOptions};
...
define_widget! {
    pub struct Label {
        ...
        draw_pos: Cell<crate::platform::Point>,
    ...
    render => (&self, frame: Rect, ctx: &mut RenderContext, _tree: &WidgetTree) {
        ...
        let opts = TextLayoutOptions {
            ...
            line_height: fs * 1.5,
            word_wrap: false,
            h_align: crate::render::HAlign::Left,
            v_align: crate::render::VAlign::Top,
            font_size: fs,
        };
        let backend_opts = crate::render::text_backend::TextLayoutOptions::from(opts);
        let fh = *ctx.font();
        ...
        let x = 0.0;
        let y = 0.0;
        let draw_pos = crate::platform::Point::new(x, y);
        self.draw_pos.set(draw_pos);
        let abs_pos = crate::platform::Point::new(frame.x + draw_pos.x, frame.y + draw_pos.y);
...
impl Label {
    pub fn new(text: impl Into<String>) -> Self {
        ...
        Self {
            ...
            draw_pos: Cell::new(crate::platform::Point::new(0.0, 0.0)),
            style: None,
        }
    }
    ...
    pub fn color(mut self, c: crate::render::Color) -> Self {
        self.color = Some(c);
        self
    }
