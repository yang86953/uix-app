    ...
    render => (&self, frame: Rect, ctx: &mut RenderContext, _tree: &WidgetTree) {
        ...
        if self.compact {
            ...
            let display = if !self.icon.is_empty() {
                crate::widget::widgets::icon::icon_char(&self.icon)
...
impl Navigation {
    ...
    pub fn build(
        self,
        tokens: &dyn crate::api::widget::theme::TokenProvider,
    ) -> crate::widget::WidgetNode {
        let loc = crate::widget::locale::use_locale();
        use crate::widget::IntoWidgetNode;
        use crate::widget::widgets::{Container, Divider, Label};
        ...
        crate::widget::WidgetNode::new(
            Box::new(
                Container::new()
                    ...
                    .dir(crate::api::widget::FlexDirection::Column)
                    .w(self.width)
