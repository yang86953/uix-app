...
define_widget! {
    ...
    render => (&self, frame: Rect, ctx: &mut RenderContext, _tree: &WidgetTree) {
        ...
        let corner = Some(crate::render::Radius::uniform(3.0));
        ...
        if self.focused {
            ctx.stroke_rect(Rect::new(box_x - 1.0, box_y - 1.0, box_size + 2.0, box_size + 2.0), primary, 1.5, Some(crate::render::Radius::uniform(4.0)));
        }
