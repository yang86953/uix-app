...
use crate::render::text::TextRenderService;
use crate::render::text_backend::TextLayout;
use crate::render::traits::Canvas2D;
use crate::render::{Color, FontHandle};
use crate::platform::{Point, Rect, Size};

use crate::api::widget::{DebugRenderer, TextRenderer};
...
impl<'a> TextRenderer for TextRenderService<'a> {
    ...
    fn font_service(&mut self) -> &crate::render::font_service::FontService {
        self.font_service
    }
