...
use crate::platform::StatusLevel;
use std::collections::VecDeque;

/// 通知级别（统一使用 uix_platform::StatusLevel）。
pub use crate::platform::StatusLevel as NotificationLevel;
...
pub struct NotificationService {
    ...
    platform_notifier: Option<Box<dyn crate::platform::INotification>>,
    /// 应用内 Toast 队列。
...
impl NotificationService {
    ...
    pub fn with_platform(mut self, notifier: Box<dyn crate::platform::INotification>) -> Self {
...
mod tests {
    ...
    fn test_with_platform_delegates_system_notification() {
        ...
        impl crate::platform::INotification for SpyNotifier {
