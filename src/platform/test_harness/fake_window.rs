...
use crate::platform::api::present::{IGraphicsContext, IPresenter};
use crate::platform::api::window::{INativeHandle, IWindowManager, IWindowProperties, PlatformWindow};
use crate::platform::api::error::Result;
use crate::platform::api::geometry::Point;
use crate::platform::test_harness::fake_graphics_context::FakeGraphicsContext;
use crate::platform::test_harness::fake_presenter::FakePresenter;
