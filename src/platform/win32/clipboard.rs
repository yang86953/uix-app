// ============================================================================
// uix-platform/src/win32/clipboard.rs — Win32 clipboard (IClipboard)
// ============================================================================

#![cfg(windows)]

use crate::platform::win32::util::to_utf8;
use crate::platform::win32::util::to_wide;
...
impl IClipboard for Win32Clipboard {
    fn text(&self) -> String {
        unsafe {
            if OpenClipboard(self.hwnd) == 0 { return String::new(); }
            let handle = GetClipboardData(CF_UNICODETEXT);
            if handle.is_null() { CloseClipboard(); return String::new(); }
            let ptr = GlobalLock(handle) as *const u16;
            if ptr.is_null() { CloseClipboard(); return String::new(); }
            let mut len = 0;
    ...
    fn set_text(&mut self, text: &str) {
        unsafe {
            ...
            if hglobal.is_null() { CloseClipboard(); return; }
