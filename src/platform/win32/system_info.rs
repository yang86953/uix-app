// ============================================================================
// uix-platform/src/win32/system_info.rs — Win32 system info impl (ISystemInfo)
// ============================================================================
...
#[derive(Debug, Clone)]
pub struct Win32SystemInfo;

impl Win32SystemInfo {
    pub fn new() -> Self {
        Self
    }
}

impl Default for Win32SystemInfo {
    fn default() -> Self {
        Self::new()
    }
}

impl ISystemInfo for Win32SystemInfo {
