// ============================================================================
// uix-platform/src/win32/notification.rs — Win32 notification (INotification)
// ============================================================================
...
pub struct Win32Notification {
    hwnd: *mut std::ffi::c_void,
    active: bool,
}

impl Win32Notification {
    pub fn new() -> Self {
        Self {
            hwnd: ptr::null_mut(),
            active: false,
...
impl Default for Win32Notification {
    fn default() -> Self {
        Self::new()
    }
}

impl INotification for Win32Notification {
...
impl Drop for Win32Notification {
    fn drop(&mut self) {
        self.remove_icon();
    }
}
