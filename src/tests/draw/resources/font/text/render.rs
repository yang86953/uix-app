...
use crate::draw::resources::font::text::render::*;
...
fn draw_text_empty_returns_early() {
    let fs = FontService::new();
    let mut trs = TextRenderService::new(FontHandle::default(), &fs, 500.0);
    let mut canvas = crate::draw::backend::cpu::noop_canvas_2d::NoopCanvas2D;
...
fn draw_text_spatial_empty_returns_early() {
    let fs = FontService::new();
    let mut trs = TextRenderService::new(FontHandle::default(), &fs, 500.0);
    let mut canvas_s = crate::draw::backend::cpu::noop_canvas_2d::NoopCanvas2D;
    let spatial = crate::draw::geometry::spatial::SpatialContext::new(
        &mut canvas_s,
        96.0,
        1.0,
...
fn missing_glyph_emits_tofu_with_char_index() {
    use crate::draw::resources::font::text_backend::{TextLayoutOptions, TOFU_GLYPH_ID};
...
impl crate::draw::TextBackend for SparseGlyphBackend {
    ...
    fn layout_text(
        ...
        font: &FontHandle,
        _text: &str,
        _opts: &crate::draw::resources::font::text_backend::TextLayoutOptions,
    ) -> crate::draw::resources::font::text_backend::TextLayout {
        use crate::draw::resources::font::text_backend::{LineInfo, PositionedGlyph, TextLayout};
        TextLayout {
            glyphs: vec![
                PositionedGlyph {
                    x: 0.0,
    ...
    fn rasterize_glyph(
        ...
        _glyph_id: u32,
        _pixel_size: f32,
    ) -> crate::draw::resources::font::text_backend::GlyphRaster {
        crate::draw::resources::font::text_backend::GlyphRaster {
            width: 0,
            height: 0,
    ...
    fn horizontal_line_metrics(
        ...
        _font: &FontHandle,
        _pixel_size: f32,
    ) -> Option<crate::draw::resources::font::text_backend::LineMetrics> {
        Some(crate::draw::resources::font::text_backend::LineMetrics {
            ascent: 10.0,
            descent: 4.0,
            new_line_size: 14.0,
        })
