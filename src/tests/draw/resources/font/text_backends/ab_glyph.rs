use crate::draw::resources::font::text_backends::ab_glyph::*;
...
fn is_valid_unloaded_handle_returns_false() {
    ...
    assert!(backend
        .layout_text(
            &handle,
            "x",
            &crate::draw::resources::font::text_backend::TextLayoutOptions {
                max_width: f32::MAX,
                max_height: 0.0,
                line_height: 20.0,
                word_wrap: false,
...
fn layout_text_unloaded_handle_returns_empty_layout() {
    let backend = AbGlyphBackend::new();
    let opts = crate::draw::resources::font::text_backends::ab_glyph::TextLayoutOptions {
        max_width: f32::MAX,
        max_height: 0.0,
        line_height: 0.0,
        word_wrap: true,
...
fn layout_text_uses_whitespace_advance_for_tabs_instead_of_tofu() {
    ...
    assert_ne!(
        tab.glyph_id,
        crate::draw::resources::font::text_backend::TOFU_GLYPH_ID
    );
