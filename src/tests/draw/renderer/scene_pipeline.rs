...
use crate::draw::renderer::scene_pipeline::*;
use crate::draw::renderer::{InvalidationSource, RenderMetrics};
use crate::draw::scene::ScenePaint;
use crate::draw::{Canvas2D, GraphicsCapabilities};
use crate::draw::{RenderTarget, UpdateStrategy};
...
struct RecordingEngine {
    ...
    partial_redraw: bool,
    scroll_memmove: bool,
    begin_failure: Option<crate::draw::renderer::GraphicsFailure>,
    begin_outcome: Option<RenderOutcome>,
    encoded_frame_failure: Option<Error>,
    encoded_frames: Vec<Vec<crate::draw::command::FrameCommand>>,
    end_outcome: RenderOutcome,
    presentation_mode: crate::draw::PresentationMode,
...
impl RecordingEngine {
    fn new() -> Self {
        Self {
            ...
            presentation_mode: crate::draw::PresentationMode::BackendManaged,
    ...
    fn with_begin_failure(mut self, failure: crate::draw::renderer::GraphicsFailure) -> Self {
    ...
    fn with_external_presenter(mut self) -> Self {
        self.presentation_mode = crate::draw::PresentationMode::ExternalPresenter;
        self
    }
...
impl RenderTarget for RecordingEngine {
    ...
    fn try_execute_encoded_frame(
        &mut self,
        encoder: &crate::draw::command::FrameEncoder,
        ...
        match &self.encoded_frame_failure {
            ...
            None => Ok(crate::draw::command::EncodedFrameExecution::Executed),
        }
    }
...
struct CaptureBeforePresentEngine {
    inner: crate::draw::Renderer,
    encoded_frames: Vec<Vec<u32>>,
}

#[cfg(feature = "opengles")]
impl RenderTarget for CaptureBeforePresentEngine {
    ...
    fn try_execute_encoded_frame(
        ...
        if matches!(
            execution,
            crate::draw::command::EncodedFrameExecution::Executed
        ) {
            let pixels = self
                .inner
                .session_mut()
...
impl RenderTarget for EncodedRenderer {
    fn initialize(&mut self, width: i32, height: i32) -> Result<(), Error> {
        self.inner.initialize(width, height)
    }
...
#[test]
fn scene_pipeline_stops_before_paint_or_end_when_begin_frame_fails() {
    let failure = crate::draw::renderer::GraphicsFailure::SurfaceLost(Error::new(
...
#[test]
fn scene_pipeline_does_not_report_present_when_engine_declines_frame_completion() {
    let mut renderer = ScenePipeline::new();
...
#[test]
fn scene_pipeline_rejects_final_presentation_from_begin_frame() {
    let mut renderer = ScenePipeline::new();
    let mut engine =
...
#[test]
fn scene_pipeline_rejects_ready_result_from_end_frame() {
    let mut renderer = ScenePipeline::new();
    let mut engine =
...
#[test]
fn scene_pipeline_preserves_typed_graphics_failure() {
    let failure = crate::draw::renderer::GraphicsFailure::SurfaceLost(Error::new(
        crate::core::error::Errc::GraphicsSurfaceLost,
    ...
    assert!(matches!(
        output.outcome,
        RenderOutcome::Failed(crate::draw::renderer::GraphicsFailure::SurfaceLost(error))
...
fn root_and_direct_scene_execute_one_encoded_frame_before_final_present() {
    ...
    assert!(matches!(
        commands.as_slice(),
        [
            crate::draw::command::FrameCommand::Clear { .. },
            crate::draw::command::FrameCommand::Native { .. },
            crate::draw::command::FrameCommand::Native { .. },
        ]
    ));
}
...
#[cfg(feature = "d3d11")]
#[test]
fn scene_pipeline_d3d11_warp_executes_direct_and_picture_recordings_before_present() {
    ...
    let mut window = platform
        .window_manager()
        .create_window("ScenePipeline WARP recording test", 300, 300)
        .expect("window");
    ...
    let mut engine = Renderer::from_context(context).expect("native WARP engine");
    engine
        .initialize(300, 300)
    ...
    let mut direct_renderer = ScenePipeline::new();
    ...
    let mut picture_renderer = ScenePipeline::new();
...
#[cfg(feature = "opengles")]
fn scene_pipeline_wgl_executes_direct_and_picture_recordings_before_present() {
    use crate::draw::Renderer;
    ...
    let mut window = platform
        .window_manager()
        .create_window("ScenePipeline WGL recording test", 300, 300)
        .expect("window");
    ...
    let mut engine = CaptureBeforePresentEngine {
        inner: Renderer::from_context(context).expect("native WGL engine"),
        encoded_frames: Vec::new(),
    };
    engine
        .initialize(300, 300)
...
fn cached_picture_is_consumed_by_the_main_frame_encoder_before_present() {
    let mut renderer = ScenePipeline::new();
    let mut engine = EncodedRenderer::new();
...
impl ScenePaint for EmptyScene {
    fn root_id(&self) -> Option<crate::draw::renderer::NodeId> {
        None
    }
    ...
    fn node_visible(&self, _: crate::draw::renderer::NodeId) -> bool {
        false
    }
    fn node_frame(&self, _: crate::draw::renderer::NodeId) -> Rect {
        Rect::zero()
    }
    fn node_dirty(&self, _: crate::draw::renderer::NodeId) -> bool {
        false
    }
    fn node_z_index(&self, _: crate::draw::renderer::NodeId) -> i32 {
        0
    }
    fn node_children(&self, _: crate::draw::renderer::NodeId) -> &[crate::draw::renderer::NodeId] {
        &[]
    }
    fn children_clip(&self, _: crate::draw::renderer::NodeId, _: Rect) -> Option<Rect> {
        None
    }
    fn dirty_rect(&self, _: crate::draw::renderer::NodeId, frame: Rect) -> Rect {
        frame
    }
    fn scroll_offset(&self, _: crate::draw::renderer::NodeId) -> Option<(f32, f32)> {
        None
    }
    fn focused_node(&self) -> Option<crate::draw::renderer::NodeId> {
        None
    }
    fn node_focusable(&self, _: crate::draw::renderer::NodeId) -> bool {
        false
    }
    fn hit_test(&self, _: Point) -> Option<crate::draw::renderer::NodeId> {
        None
    }
    fn parent(&self, _: crate::draw::renderer::NodeId) -> Option<crate::draw::renderer::NodeId> {
        None
    }
    fn paint(&self, _: crate::draw::renderer::NodeId, _: Rect, _: &mut PaintContext<'_>) {}
}
...
struct EligiblePictureScene {
    ...
    picture_policy: crate::draw::scene::PicturePolicy,
}
...
impl EligiblePictureScene {
    fn new() -> Self {
        Self {
            ...
            picture_policy: crate::draw::scene::PicturePolicy::Eligible,
        }
    }

    fn direct() -> Self {
        Self {
            picture_policy: crate::draw::scene::PicturePolicy::Never,
            ..Self::new()
        }
    }
...
impl ScenePaint for EligiblePictureScene {
    fn root_id(&self) -> Option<crate::draw::renderer::NodeId> {
        Some(crate::draw::renderer::NodeId::new(1))
    }
    ...
    fn node_visible(&self, id: crate::draw::renderer::NodeId) -> bool {
        (1..=8).any(|slot| id == crate::draw::renderer::NodeId::new(slot))
    }

    fn node_is_overlay(&self, id: crate::draw::renderer::NodeId) -> bool {
        self.cpu_fallback_is_overlay && id == crate::draw::renderer::NodeId::new(3)
    }
    ...
    fn node_dirty(&self, id: crate::draw::renderer::NodeId) -> bool {
        if id == crate::draw::renderer::NodeId::new(1) {
            self.root_dirty.get()
        } else if id == crate::draw::renderer::NodeId::new(2) {
    ...
    fn node_children(&self, id: crate::draw::renderer::NodeId) -> &[crate::draw::renderer::NodeId] {
        static CHILDREN: [crate::draw::renderer::NodeId; 7] = [
            crate::draw::renderer::NodeId::new(2),
            crate::draw::renderer::NodeId::new(3),
            crate::draw::renderer::NodeId::new(4),
            crate::draw::renderer::NodeId::new(5),
            crate::draw::renderer::NodeId::new(6),
            crate::draw::renderer::NodeId::new(7),
            crate::draw::renderer::NodeId::new(8),
        ];
        if id == crate::draw::renderer::NodeId::new(1) {
            &CHILDREN
        } else {
    ...
    fn node_picture_policy(
        &self,
        _: crate::draw::renderer::NodeId,
    ) -> crate::draw::scene::PicturePolicy {
        self.picture_policy
    }
    ...
    fn paint(&self, id: crate::draw::renderer::NodeId, frame: Rect, ctx: &mut PaintContext<'_>) {
        if id == crate::draw::renderer::NodeId::new(1) {
        ...
        } else if id == crate::draw::renderer::NodeId::new(3) && self.include_cpu_fallback {
...
impl crate::draw::api::IColorTokens for MockTokens {
...
impl crate::draw::api::ITypographyTokens for MockTokens {
    fn font_family(&self) -> &str {
        "sans"
    }
}

impl crate::draw::api::IBoxShadowTokens for MockTokens {
    fn box_shadow(&self) -> crate::draw::api::ShadowToken {
        crate::draw::api::ShadowToken::none()
    }
    fn box_shadow_secondary(&self) -> crate::draw::api::ShadowToken {
        crate::draw::api::ShadowToken::none()
    }
}

impl crate::draw::api::ISpacingTokens for MockTokens {}

impl crate::draw::api::ThemeTokens for MockTokens {}
...
fn first_frame_expands_partial_dirty_to_full_paint_region() {
    ...
    impl ScenePaint for PartialDirtyScene {
        ...
        fn node_frame(&self, id: crate::draw::renderer::NodeId) -> Rect {
            match id {
                id if id == crate::draw::renderer::NodeId::new(1) => {
                    Rect::new(0.0, 0.0, 100.0, 100.0)
                }
                id if id == crate::draw::renderer::NodeId::new(2) => {
        ...
        fn node_children(
            &self,
            id: crate::draw::renderer::NodeId,
        ) -> &[crate::draw::renderer::NodeId] {
            static ROOT_KIDS: [crate::draw::renderer::NodeId; 1] =
                [crate::draw::renderer::NodeId::new(2)];
            static EMPTY: [crate::draw::renderer::NodeId; 0] = [];
            if id == crate::draw::renderer::NodeId::new(1) {
                &ROOT_KIDS
            } else {
                &EMPTY
        ...
        fn parent(
            &self,
            id: crate::draw::renderer::NodeId,
        ) -> Option<crate::draw::renderer::NodeId> {
            if id == crate::draw::renderer::NodeId::new(2) {
                Some(crate::draw::renderer::NodeId::new(1))
            } else {
                None
            }
...
#[test]
fn scene_pipeline_marks_external_presenter_output_as_pending() {
    let mut renderer = ScenePipeline::new();
...
fn dirty_frame_paint_is_faster_than_full_frame_on_dense_scene() {
    ...
    impl ScenePaint for DenseScene {
        ...
        fn node_children(
            ...
            static CHILDREN: [crate::draw::renderer::NodeId; 100] = {
                let mut kids = [crate::draw::renderer::NodeId::new(0); 100];
                let mut i = 0;
                while i < 100 {
                    kids[i] = crate::draw::renderer::NodeId::new(i + 2);
                    i += 1;
                }
                kids
            };
        ...
        fn node_picture_policy(
            ...
            crate::draw::scene::PicturePolicy::Never
        }
        fn children_clip(&self, _: crate::draw::renderer::NodeId, _: Rect) -> Option<Rect> {
            None
        }
...
fn dirty_frame_parent_bg_must_not_wipe_undamaged_sibling() {
    ...
    impl ScenePaint for SiblingScene {
        ...
        fn node_children(
            ...
            static KIDS: [crate::draw::renderer::NodeId; 2] = [
                crate::draw::renderer::NodeId::new(2),
                crate::draw::renderer::NodeId::new(3),
            ];
            if id.slot() == 1 {
...
fn scroll_move_shifts_viewport_content_and_repaints_exposed_strip() {
    ...
    let px = |engine: &Renderer, x: usize, y: usize| {
...
fn scroll_move_keeps_copy_outside_the_main_paint_encoder() {
    ...
    let has_scroll_copy = commands.iter().any(|cmd| {
        matches!(
            cmd,
            crate::draw::command::FrameCommand::Native {
                operation: crate::draw::command::FrameRasterOp::ScrollCopy { .. }
            }
        )
    });
    assert!(
...
const BACKDROP_ROOT: crate::draw::renderer::NodeId = crate::draw::renderer::NodeId::new(1);
const BACKDROP_OVERLAY: crate::draw::renderer::NodeId = crate::draw::renderer::NodeId::new(2);

struct OverlayBackdropScene {
    children: [crate::draw::renderer::NodeId; 1],
    version: Cell<u64>,
...
impl ScenePaint for OverlayBackdropScene {
    ...
    fn node_z_index(&self, id: crate::draw::renderer::NodeId) -> i32 {
    ...
    fn parent(&self, id: crate::draw::renderer::NodeId) -> Option<crate::draw::renderer::NodeId> {
...
fn expected_masked_pixel(background: Color, alpha: u8) -> u32 {
    use crate::draw::command::{FrameEncoder, FrameRasterOp, FrameRect};
...
fn full_overlay_frames_restore_clean_backdrop_without_repainting_normal_tree() {
    ...
    assert!(engine.encoded_frames.last().is_some_and(|commands| {
        commands.iter().any(|command| {
            matches!(
                command,
                crate::draw::command::FrameCommand::PictureBlit { .. }
            )
        })
    }));
    assert_eq!(
...
impl RenderTarget for GpuOverlayBackdropEngine {
    fn initialize(&mut self, width: i32, height: i32) -> Result<(), Error> {
    ...
    fn raster_pipeline(&self) -> crate::draw::renderer::RasterPipeline {
        crate::draw::renderer::RasterPipeline::GpuNative
    }
