...
use crate::draw::{DamageRegion, RenderOutcome, Renderer};
...
impl ScenePaint for ResizeSiblingScene {
    ...
    fn node_children(&self, id: crate::draw::renderer::NodeId) -> &[crate::draw::renderer::NodeId] {
        static CHILDREN: [crate::draw::renderer::NodeId; 2] = [
    ...
    fn parent(&self, id: crate::draw::renderer::NodeId) -> Option<crate::draw::renderer::NodeId> {
        (id.slot() != 1).then(|| crate::draw::renderer::NodeId::new(1))
    }
...
impl RenderTarget for NarrowBeginEngine {
...
fn resize_promoted_full_clear_also_promotes_paint_and_present_damage() {
    ...
    engine.initialize(100, 40).expect("initialize CPU renderer");
