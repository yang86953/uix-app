...
fn stroke_caps_and_joins_tessellate_without_gaps_or_area_overlap() {
    ...
    for (join, limit, expected_area) in [
        (crate::draw::geometry::path::LineJoin::Miter, 2.0, 1_536.0),
        (crate::draw::geometry::path::LineJoin::Miter, 1.0, 1_504.0),
        (crate::draw::geometry::path::LineJoin::Bevel, 4.0, 1_504.0),
    ] {
    ...
    for cap in [
        crate::draw::geometry::path::LineCap::Butt,
    ...
    closed
        ...
        .close();
    for join in [
        crate::draw::geometry::path::LineJoin::Miter,
        ...
        assert!(tessellate_stroke(
            ...
            &StrokeOptions {
                width: 8.0,
                cap: crate::draw::geometry::path::LineCap::Square,
                join,
                miter_limit: 4.0,
            },
        )
