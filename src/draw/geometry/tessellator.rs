...
// 几何谓词与 ear-clip 三角剖分辅助函数拆分到独立模块。
mod geometry;
use super::flattener;
...
// 引入拆分后的几何辅助函数。
use geometry::{
    bounds_overlap, cross_f64, ear_clip, edges_are_adjacent, ordered_or_snapped, point_in_ring,
    polygon_area_f64, ring_bounds, rings_intersect_or_touch, segments_intersect_or_touch,
};
