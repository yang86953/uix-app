...
use crate::scanner::{self, ScanSymbolKind};
use crate::session::Session;
use serde_json::{Value, json};
use uix_lang_compiler::semantic_ir::{TypedDeclarationKind, TypedNode};
...
fn declaration_symbol(
    declaration: &uix_lang_compiler::semantic_ir::TypedDeclaration,
    text: &str,
    index: &LineIndex,
) -> Value {
