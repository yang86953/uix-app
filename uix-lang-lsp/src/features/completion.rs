...
use crate::scanner::{self, CompletionContext, ScanSymbolKind};
use crate::session::Session;
use serde_json::{Value, json};
use std::collections::BTreeSet;
use uix_lang_compiler::CompilerSystem;
use uix_lang_compiler::projection_schema::RegistrationStatus;
...
fn token_detail(entry: &uix_lang_compiler::projection_schema::ThemeTokenSpec) -> String {
    let alias = entry
        .alias_for
