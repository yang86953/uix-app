...
这里维护 ODC-01/ODC-04/ODC-06/ODC-07 的二十九个独立 fixture 目录、两个根二进制配置、复用最小与 Agent fixture 的两个 Linux 目标配置，以及复用 `backend-selection` fixture 的额外五个 feature 配置，共三十八个相互清理的入口：
...
- `demo-logging`：使用相同演示基础组合，再启用 `demo-logging` 并构建 GUI 演示项目的 `uix-demo`。
