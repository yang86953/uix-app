...
| <a id="d180"></a>180 | 应用作者门面待落地 | [#179](#d179) 下可执行台账（落地时回写）。**P0**：`State::update`、多 State clone、任意 View `on_click`、条件/列表组合子。**P1**：`on_click_fn` 命名、Style 链式噪音、`column` grow 心智、宏边界、示例 vs 探针。导航 → [术语与公开面](架构.md#术语与公开面) |
