...
> **接口**：声明 UIX 推荐界面描述方式（uix-lang）的第一个编译期 View——依赖配置、Hello World，以及后续目标设计示例。依赖：[uix-lang 语言规范](../README.md)、[语法](../规范/语法.md)。导出：uix-lang 教程 → [教程](教程.md)。
>
...
| 完整计数器应用 | 本页目标设计 | [快速开始 · 带交互的计数器](../../使用/快速开始.md#带交互的计数器) |
| 完整 TODO 应用 | [uix-lang 教程（目标设计）](教程.md) | [教程](教程.md) |
