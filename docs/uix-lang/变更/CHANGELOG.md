...
| 日期 | 范围 | 说明 | 关联 |
|---|---|---|---|
| 2026-08-15 | Component | 实现 `external` 外部依赖白名单与组件体未声明标识符的精确 SourceSpan 诊断 | #1011 |
| 2026-08 | 文档 | 文档体系按「规范 / 参考 / 指南 / 变更」重构；规范拆分九篇，新增术语表、事件参考、版本策略 | #2157-#2161 前置 |

### 目标设计（未实现，不构成兼容性承诺）

见 [目标设计](目标设计.md)：内容插槽、错误行号回映、数组操作扩展与受限闭包、computed 派生状态、主题 token 全量扩展、状态伪类、语法小项（If/ElseIf/Else、事件载荷表、props 默认值、类型白名单）。对应 Vikunja 任务 #2157-#2161。
