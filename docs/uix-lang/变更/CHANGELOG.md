...
| 日期 | 范围 | 说明 | 关联 |
|---|---|---|---|
| 2026-08-24 | 编译契约 / Widget | 新增顶层 `<Visual>` 具名静态视觉记录与 `uix_items!` 常量生成，使构造、测量、绘制和组合根共享 UIX 唯一事实源；固定数组保持 const 数组语义，并增加双源默认表与巨型位置参数壳的只减不增守卫 | [组件规范](../规范/组件.md#5-静态视觉记录visual) |
