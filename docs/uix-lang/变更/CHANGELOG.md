...
| 日期 | 范围 | 说明 | 关联 |
|---|---|---|---|
| 2026-08-21 | 产品方向 / 职责边界 | 撤回“应用开发语言”方向，明确 uix-lang 只描述 UI，业务逻辑、领域状态、服务、异步流程与生命周期由 Rust 持有；既有同步 action 收敛为局部 UI 交互编排 | [UI 描述语言边界](应用开发语言目标.md) |
...
| 2026-08-20 | 产品方向 / 编译模式 | 曾将 uix-lang 定位为应用开发主语言；该方向已于 2026-08-21 撤回，保留本条作为历史记录 | [UI 描述语言边界](应用开发语言目标.md) |
