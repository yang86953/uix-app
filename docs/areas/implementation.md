...
| 布局两阶段缓存收敛 | 通用 Flex/Grid 已消费 `LayoutChild.measured_size`；ScrollView、Space、Form/Card 等自定义 arrange 仍会按父 frame 重新 measure，须统一改为 Phase 1 缓存输入 | [layout · Measure / Arrange](systems/layout.md#measure--arrange-两阶段) |
