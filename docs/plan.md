...
| P6 图形后端 | D3D11/Vulkan/配置/macOS AppKit SoftwareEngine bootstrap + 基础输入事件已落地，D3D12/Metal/更完整 native GPU renderer 待推进 | 推进前读 [rendering](areas/systems/rendering.md)、[platform](areas/systems/platform.md)、[#162](decisions.md#d162) |
