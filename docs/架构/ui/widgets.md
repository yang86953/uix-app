...
已完成同目录与公开根迁移、仍待回填视觉声明的组件：`ResultView`、`Tag`、`ProgressBar`、`Spin`、`Badge`、`QRCode`、`Watermark`、`Card`、`Carousel`、`Descriptions`、`Image` 与 `ImageGroup`。这些条目不能作为最终完成状态；对应债务清单由结构测试锁定并逐项缩减。
