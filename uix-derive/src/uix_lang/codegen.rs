...
use super::{
    ...
    generate_column, generate_container, generate_date_picker, generate_divider,
    ...
    generate_splitter, generate_switch, generate_theme_toggle, generate_tree_select,
...
fn generate_element(element: &Element) -> Result<TokenStream, Diagnostic> {
    ...
    match element.name.as_str() {
        ...
        _ => Err(Diagnostic::new(
            ...
            // 指向明确支持路径。
            "使用 Text、Label、Button、ButtonGroup、FloatButton、Icon、Divider、Space、Typography、ThemeToggle、WindowControl、Container、Row、Column、Grid、ScrollView、VirtualScroll、Splitter、Affix、BackTop、Layout、Sider、Header、Content、Footer、Input、InputNumber、InputGroup、Slider、RangeSlider、Rate、Checkbox、Switch、Radio、Segmented、Select、Cascader、TreeSelect、AutoComplete、Mentions 或 DatePicker，或先登记组件状态",
        )),
    }
}
