...
impl<'a> TextRenderer for TextRenderService<'a> {
    ...
    fn font_service(&mut self) -> &uix_graphics::font_service::FontService {
        self.font_service
    }
