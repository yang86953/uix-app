...
pub struct TextManager {
    ...
    font_size: f32,
    font_path: String,
    color: Option<uix_graphics::Color>,
    placeholder: String,
    bold: bool,
    italic: bool,
    alignment: uix_graphics::HAlign,
}
...
impl TextManager {
    ...
    pub fn color(&self) -> Option<uix_graphics::Color> {
        self.color
    }
    pub fn set_color(&mut self, c: uix_graphics::Color) {
        self.color = Some(c);
    }
    ...
    pub fn alignment(&self) -> &uix_graphics::HAlign {
        &self.alignment
    }
    pub fn set_alignment(&mut self, a: uix_graphics::HAlign) {
        self.alignment = a;
    }
