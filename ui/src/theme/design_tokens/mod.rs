...
impl IColorTokens for DesignTokens {
    ...
    fn color_bg_layout(&self) -> Color { self.color_bg_layout }
    fn color_bg_spotlight(&self) -> Color { self.color_bg_spotlight }
    fn color_bg_mask(&self) -> Color { self.color_bg_mask }
    ...
    fn color_fill_quaternary(&self) -> Color { self.color_fill_quaternary }
    ...
    fn color_white(&self) -> Color { self.color_white }
    fn color_black(&self) -> Color { self.color_black }
    ...
    fn color_success_bg(&self) -> Color { self.color_success_bg }
    fn color_success_border(&self) -> Color { self.color_success_border }
    fn color_warning(&self) -> Color { self.color_warning }
    fn color_warning_bg(&self) -> Color { self.color_warning_bg }
    fn color_warning_border(&self) -> Color { self.color_warning_border }
    fn color_error(&self) -> Color { self.color_error }
    fn color_error_bg(&self) -> Color { self.color_error_bg }
    fn color_error_border(&self) -> Color { self.color_error_border }
    fn color_info(&self) -> Color { self.color_info }
    fn color_info_bg(&self) -> Color { self.color_info_bg }
    fn color_info_border(&self) -> Color { self.color_info_border }
    fn color_link(&self) -> Color { self.color_link }
    fn color_link_hover(&self) -> Color { self.color_link_hover }
    fn color_link_active(&self) -> Color { self.color_link_active }
}

impl ITypographyTokens for DesignTokens {
    fn font_family(&self) -> &str { self.font_family }
    fn font_size_sm(&self) -> f32 { self.font_size_sm }
    fn font_size(&self) -> f32 { self.font_size }
    fn font_size_lg(&self) -> f32 { self.font_size_lg }
    fn font_size_xl(&self) -> f32 { self.font_size_xl }
    fn font_size_heading_1(&self) -> f32 { self.font_size_heading_1 }
    fn font_size_heading_2(&self) -> f32 { self.font_size_heading_2 }
    fn font_size_heading_3(&self) -> f32 { self.font_size_heading_3 }
    fn font_size_heading_4(&self) -> f32 { self.font_size_heading_4 }
    fn font_size_heading_5(&self) -> f32 { self.font_size_heading_5 }
    fn font_weight_regular(&self) -> f32 { self.font_weight_regular }
    fn font_weight_medium(&self) -> f32 { self.font_weight_medium }
    fn font_weight_semibold(&self) -> f32 { self.font_weight_semibold }
    fn font_weight_bold(&self) -> f32 { self.font_weight_bold }
    fn line_height(&self) -> f32 { self.line_height }
}

impl ISpacingTokens for DesignTokens {
    fn padding_xss(&self) -> f32 { self.padding_xss }
    fn padding_xs(&self) -> f32 { self.padding_xs }
    fn padding_sm(&self) -> f32 { self.padding_sm }
    fn padding(&self) -> f32 { self.padding }
    fn padding_md(&self) -> f32 { self.padding_md }
    fn padding_lg(&self) -> f32 { self.padding_lg }
    fn padding_xl(&self) -> f32 { self.padding_xl }
    ...
    fn border_radius_xl(&self) -> f32 { self.border_radius_xl }
    fn border_radius_round(&self) -> f32 { self.border_radius_round }
    ...
    fn motion_duration_fast(&self) -> f32 { self.motion_duration_fast }
    fn motion_duration_mid(&self) -> f32 { self.motion_duration_mid }
    fn motion_duration_slow(&self) -> f32 { self.motion_duration_slow }
    fn motion_easing_default(&self) -> &str { self.motion_easing_default }
    fn motion_easing_in(&self) -> &str { self.motion_easing_in }
    fn motion_easing_out(&self) -> &str { self.motion_easing_out }
    fn motion_easing_in_out(&self) -> &str { self.motion_easing_in_out }
    fn screen_xs(&self) -> f32 { self.screen_xs }
    fn screen_sm(&self) -> f32 { self.screen_sm }
    fn screen_md(&self) -> f32 { self.screen_md }
    fn screen_lg(&self) -> f32 { self.screen_lg }
    fn screen_xl(&self) -> f32 { self.screen_xl }
    fn screen_xxl(&self) -> f32 { self.screen_xxl }
}

impl IBoxShadowTokens for DesignTokens {
    fn box_shadow(&self) -> ShadowToken { self.box_shadow }
    fn box_shadow_secondary(&self) -> ShadowToken { self.box_shadow_secondary }
}
...
mod tests {
    ...
    fn antd_light_primary_color() {
        let tk = DesignTokens::antd_light();
        // Ant Design 5 primary blue: #1677FF
    ...
    fn box_shadow_tokens_light() {
        let tk = DesignTokens::antd_light();
        // Light mode shadows should have non-transparent layers
        let shadow = tk.box_shadow();
        assert!(shadow.layer_1.2 > 0.0);  // blur > 0
