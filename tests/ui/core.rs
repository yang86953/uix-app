//! ui 域 — 核心模块（state/style/clipboard）集成测试。
...
use uix::prelude::*;
use uix::ui::{
    copy_to_clipboard, Effect, WidgetCapabilities, WidgetChildren, WidgetComponent, WidgetRender,
};
...
impl WidgetComponent for DummyWidget {
    ...
    uix::wc_upcast!(DummyWidget; WidgetRender);
}
