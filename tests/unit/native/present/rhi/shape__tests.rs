    ...
    fn native_shape_shaders_encode_the_shared_contract() {
        ...
        let d3d_source = include_str!("../../../../../src/native/presentation/graphics/d3d11/platform/pipeline/mod.rs");
        ...
        let gl_source = include_str!("../../../../../src/native/presentation/graphics/opengl/raster/rhi_shaders.rs");
        ...
        let gl_pipeline_source =
            include_str!("../../../../../src/native/presentation/graphics/opengl/raster/rhi_device_pipeline.rs");
