...
use super::{
    MSDF_ATLAS_LIMIT_BYTES, MSDF_ATLAS_MAX_PAGES, MSDF_ATLAS_PAGE_SIZE, MsdfAtlasPage, RhiRenderer,
};
...
fn msdf_padding_copies_edge_pixels() {
    ...
    assert_eq!(
        padded,
        vec![
            1, 2, 3, 4, 1, 2, 3, 4, 5, 6, 7, 8, 5, 6, 7, 8, 1, 2, 3, 4, 1, 2, 3, 4, 5, 6, 7, 8, 5,
            6, 7, 8, 9, 10, 11, 12, 9, 10, 11, 12, 13, 14, 15, 16, 13, 14, 15, 16, 9, 10, 11, 12,
            9, 10, 11, 12, 13, 14, 15, 16, 13, 14, 15, 16,
        ]
    );
}
